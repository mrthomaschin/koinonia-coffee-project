  ...
  return (
    <main className="contact-page" style={{ minHeight: availableHeight }}>
      ...
      <section className="contact-main-section">
        <div className="contact-intro"><p className="eyebrow">Contact Us</p><h1>Good things<br />usually begin with<br />a conversation.</h1><p className="intro-copy">Questions, ideas, event plans, or just want to talk<br className="desktop-break" /> coffee? We’d love to hear from you.</p><a className="contact-email" href="mailto:hello@koinoniacoffeeproject.com">hello@koinoniacoffeeproject.com</a></div>
